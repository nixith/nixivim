...
return {
		...
		after = function()
			require("lazydev").setup({
				library = {
					...
					-- Load nixCats types when the `nixCats` word is found
					{ path = require("nixCats").nixCatsPath .. "/lua", words = { "nixCats" } },
				},
				integrations = {
	...
	-- { -- optional completion source for require statements and module annotations #TODO: completion support for lazydev
	-- 	"hrsh7th/nvim-cmp",
